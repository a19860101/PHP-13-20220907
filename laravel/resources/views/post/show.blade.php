            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="/user/post/{{$post->id}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="">封面</label>
                                ...
                                <a href="/user/deleteCover/{{$post->id}}"class="bg-rose-900 text-white px-4 py-2">刪除封面</a>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="published" id="" class="border border-zinc-400 rounded w-full p-3">
                                ...
                                <option value="0"{{$post->published == 1 ? 'selected':'';}}>下架</option>
                            </select>
                        </div>
                    ...
                    <form action="" method="post">
                        @csrf
                        @method('delete')
                        <input type="submit" value="刪除" class="px-3 py-2 bg-red-600 rounded text-white">
